  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn(
        ...
        hasBlur && "supports-backdrop-filter:backdrop-blur-sm",
        className,
      )}
      {...props}
    />
...
function DrawerContent({
  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      {showOverlay && <DrawerOverlay hasBlur={overlayBlur} />}
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="mx-auto mt-4 hidden h-1.5 w-[100px] shrink-0 rounded-full bg-primary-foreground/20 group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
